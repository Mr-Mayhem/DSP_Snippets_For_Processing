...
void draw() {
  ...
  // shift left by half x to properly position the raw 1st derivative plot. 
  ...
  // shift left by half the kernel and half x to position the x axis of the smoothed 1st derivative plot
